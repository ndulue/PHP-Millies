<?php 
    ...
    if (isset($_SESSION['location']) && isset($_SESSION['type']) && isset($_SESSION['status']) && isset($_SESSION['bathroom']) && isset($_SESSION['bedroom'])) {
            ...
            <div class="mixitup-gallery">
                ...
                <div class="filter-list row">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM `property` WHERE `location` LIKE '%$location%' AND 'type' LIKE '%$type%' AND 'status' LIKE '%$status%' AND 'bathroom' LIKE '%$bathroom%' AND 'bedroom' LIKE '%$bedroom%'  ORDER BY rand() LIMIT $continue,$after";
